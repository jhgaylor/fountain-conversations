/**
 * "Sign in with Fountain": OAuth 2.0 authorization code + PKCE (S256),
 * public client. The token we get back is a Fountain API key, so the rest of
 * the app is unchanged — it just did not have to be pasted.
 *
...
const CLIENT_ID = "fountain-conversations";
const STASH = "fountain-conversations.oauth";
 ...
 * (denied, state mismatch, exchange rejected).
 */
